...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Extract features from audio datasets"
    )
    ...
    cfg_input = paths.get("audio_dir", "neurofeatures/data/audio")
    cfg_output = paths.get("audio_feat_dir", "neurofeatures/outputs")
    
    audio_dir = Path(args.input_dir or cfg_input)
    output_dir = Path(args.output_feat_dir or cfg_output)
    output_file = output_dir / "audio_features.npz"
